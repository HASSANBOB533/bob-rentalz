# BOB (Best of Bedz) Brand Guidelines

**Extracted from Brand Book - November 13, 2025**
...
- **Light Cream/Beige**
  - CMYK: 5/3/14/0
  - HEX: #F9F4D0
  - Usage: Primary background, accent areas
...
- **Captions/Small Text:** Mundial Narrow Light
...
4. **White on Blue** - Professional, trust-building
5. **White on Green** - Eco-friendly, verified properties
...
- **Don't:**
  ...
  - Add effects (drop shadow, outline, glow)
  - Rotate the logo
...
- XL: 24px (hero sections, modal dialogs)
...
- Border Radius: 16px
- Shadow: Soft (default), Hover (on interaction)
- Padding: 24px
...
- Border Radius: 8px
- Padding: 12px 16px
- Focus State: Border color #2B4682, outline 2px
...
- Hero images should have subtle gradient overlays for text legibility
...
4. **Phase 4:** Replace logo variations across site
5. **Phase 5:** Update illustrations and icons to match palette
