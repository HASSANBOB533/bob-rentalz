...
export function SearchBar({ onSearch }: SearchBarProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-4 border border-[#E5E7EB]">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="flex items-end">
          <Button
            type="submit"
            className="w-full bg-[#D4AF37] hover:bg-[#B8941F] text-white h-10"
          >
