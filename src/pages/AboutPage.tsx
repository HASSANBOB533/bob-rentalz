        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center px-6 md:px-10 lg:px-12 pt-16 md:pt-20 lg:pt-24">
          ...
          >
            ...
            <p className="text-gray-200 drop-shadow-lg text-[14px] md:text-[15px] lg:text-[16px] leading-relaxed max-w-[650px] mx-auto mb-4 md:mb-5 lg:mb-6">
              Trusted hospitality solutions for short-term rentals, long-term rentals, and real
              estate investment.
            </p>
          </motion.div>
        </div>
          ...
          <motion.div {...fadeInUp} className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-4 md:p-6 lg:p-8 shadow-sm border border-gray-100">
              <div className="flex items-center gap-3 mb-3 md:mb-4">
                ...
                <h2 className="text-[#2B2B2B] text-[20px] md:text-[26px] lg:text-[30px] leading-[1.2] font-semibold">
                  About Best of Bedz
                </h2>
              </div>
              <p className="text-[14px] md:text-base lg:text-[17px] text-[#2B2B2B]/80 md:text-gray-700 leading-[1.6] md:leading-relaxed max-w-[350px] md:max-w-full mx-auto md:mx-0 mb-0">
                Best of Bedz is a leading provider of integrated hospitality and property management
                solutions in Egypt. We deliver exceptional experiences for guests, property owners,
                and investors through three main service pillars:{' '}
                <strong>Short-Term Rentals</strong>, <strong>Long-Term Rentals (LTR)</strong>, and{' '}
                <strong>Real Estate Investment</strong>. Our upcoming website and mobile app will
                offer a seamless, tech-driven experience for everyone.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 max-w-6xl mx-auto">
            ...
            >
              ...
              <h3 className="text-[17px] md:text-[19px] lg:text-[22px] leading-[1.3] font-semibold mb-2 md:mb-3 text-[#2B2B2B]">
                Our Mission
              </h3>
              <p className="text-[14px] md:text-base text-[#2B2B2B]/80 md:text-gray-700 leading-[1.6] md:leading-relaxed max-w-[350px] md:max-w-full">
                To redefine the travel and property management experience through exceptional
                quality, personalized service, and innovative technology—creating memorable journeys
                and maximizing value for owners and investors.
              </p>
            </motion.div>
      ...
      <section className="py-4 md:py-8 lg:py-10 bg-[#F8F9FA] mb-4 md:mb-0">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div {...fadeInUp} className="text-left md:text-center mb-4 md:mb-7 lg:mb-8">
            <h2 className="text-[20px] md:text-[26px] lg:text-[30px] leading-[1.2] font-semibold mb-2 md:mb-3 text-[#2B2B2B]">
              Core Values
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto">
            ...
            >
              ...
              <h4 className="text-[16px] md:text-[18px] leading-[1.3] font-semibold mb-2 text-[#2B2B2B]">
                Quality
              </h4>
            ...
            <motion.div
              ...
              className="bg-white rounded-xl p-4 md:p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow md:col-span-2 lg:col-span-1"
            >
              <div className="w-10 h-10 md:w-12 md:h-12 bg-[#D4AF37]/10 rounded-lg flex items-center justify-center mb-3 md:mb-4">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-7xl mx-auto">
            ...
            <FlipCard
              ...
              backBullets={['Verified agents only', 'Fast search tools', 'Easy digital contracts']}
      ...
      <section className="py-6 md:py-12 lg:py-16 bg-white mb-8 md:mb-0">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div {...fadeInUp} className="text-left md:text-center mb-6 md:mb-10 lg:mb-12">
            <h2 className="text-[22px] md:text-[32px] lg:text-[36px] leading-[1.2] font-semibold mb-3 md:mb-4 text-[#2B2B2B]">
              Competitive Advantages
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-5xl mx-auto">
            <motion.div
              {...fadeInUp}
              className="bg-gradient-to-br from-[#F8F9FA] to-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-100"
            >
            ...
            <motion.div
              {...fadeInUp}
              transition={{ delay: 0.4 }}
              className="bg-gradient-to-br from-[#F8F9FA] to-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-100 md:col-span-2"
            >
              <div className="flex items-start gap-3 md:gap-4">
                <div className="w-10 h-10 bg-[#D4AF37]/10 rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-6 md:py-12 lg:py-16 bg-[#F8F9FA] mb-8 md:mb-0">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto">
            ...
            <motion.div
              {...fadeInUp}
              className="bg-white rounded-2xl p-4 md:p-6 lg:p-8 shadow-sm border border-gray-100"
            >
              <div className="flex items-center gap-3 mb-4 md:mb-6">
                ...
                <div>
                  <h3 className="text-[18px] md:text-[20px] lg:text-[22px] leading-[1.3] font-semibold mb-1 text-[#2B2B2B]">
                    Model One
                  </h3>
              ...
              <div className="flex items-center gap-3 mb-4 md:mb-6">
                ...
                <div>
                  ...
                  <p className="text-[13px] md:text-sm text-gray-500">
                    One-Time Fee + Monthly Management
                  </p>
                </div>
              </div>
      ...
      <section className="py-8 md:py-10 lg:py-12 bg-white">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div {...fadeInUp} className="text-center mb-6 md:mb-8 lg:mb-10">
            <h2 className="mb-3 text-[#2B2B2B] text-[22px] md:text-[28px] lg:text-[32px]">
          ...
          <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
            ...
            <motion.div {...fadeInUp}>
              <div className="flex items-center gap-3 mb-3 md:mb-6 px-4 md:px-0 pt-4 md:pt-0 pb-4 md:pb-0">
                ...
                <h3 className="text-[#2B2B2B] text-[16px] md:text-[28px] lg:text-[32px] leading-[1.25] md:leading-normal font-semibold max-w-[320px] md:max-w-none">
                  For Property Owners
                </h3>
              </div>
              ...
              <Accordion type="single" collapsible className="space-y-3 md:space-y-4">
                <AccordionItem
                  value="owner-1"
                  className="bg-white rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.05)] border-0 overflow-hidden"
                >
                ...
                >
                  ...
                  <AccordionContent className="px-5 md:px-6 lg:px-7 pb-4 md:pb-5 lg:pb-6">
                    <p className="text-gray-700 text-[14px] md:text-[15px] lg:text-[16px] leading-[1.5]">
                      We document issues, coordinate repairs, and manage compensation based on lease
                      terms.
                    </p>
                  </AccordionContent>
                </AccordionItem>
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.4 }}>
              <div className="flex items-center gap-3 mb-3 md:mb-6 px-4 md:px-0 pt-4 md:pt-0 pb-4 md:pb-0">
                ...
                <h3 className="text-[#2B2B2B] text-[20px] md:text-[28px] lg:text-[32px] leading-[1.25] md:leading-normal font-semibold max-w-[320px] md:max-w-none">
                  For Agents
                </h3>
              </div>
      ...
      <section className="w-full py-12 md:py-16 lg:py-20 bg-gradient-to-br from-[#2B2B2B] to-[#1a1a1a] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <motion.div {...fadeInUp} className="max-w-2xl mx-auto text-center">
            <h2 className="mb-3 md:mb-4 text-white text-left md:text-center text-[20px] md:text-[28px] lg:text-[32px] leading-[1.25] md:leading-normal font-semibold max-w-[320px] md:max-w-none mx-auto">
