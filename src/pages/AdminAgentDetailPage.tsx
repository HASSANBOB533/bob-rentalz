  ...
  '1': {
    ...
    leads: [
      {
        ...
        message: 'Is this still available for next month?',
        status: 'New',
      },
      {
        id: 'L2',
        tenantName: 'Mona Lisa',
        propertyName: 'Sunny Studio',
        message: 'I would like to schedule a viewing for this weekend.',
        status: 'Contacted',
      },
      {
        id: 'L3',
        tenantName: 'Tarek Omar',
        propertyName: 'Garden Duplex',
    ...
    viewings: {
      ...
      completed: [
        {
          id: 'V3',
          tenantName: 'Sally Ride',
          propertyName: 'Modern Apartment',
          date: 'Oct 20, 2025',
          notes: 'Tenant liked the kitchen but found the bedroom small.',
        },
        {
          id: 'V4',
          tenantName: 'Omar Sharif',
          propertyName: 'Sunny Studio',
          date: 'Oct 18, 2025',
          notes: 'Client is very interested, sent offer.',
        },
      ],
    },
    performance: {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                {agent.properties.map((prop: any) => (
                  <div
                    key={prop.id}
                    className="bg-white border border-gray-200 rounded-lg p-4 hover:border-blue-200 transition-colors shadow-sm flex flex-col"
                  >
                    ...
                    <div className="mt-auto flex items-center justify-between pt-3 border-t border-gray-100">
                      <Button
                        ...
                        onClick={() => handleRemoveFromProperty(prop.id)}
                      >
                      ...
                      <Link to={`/admin/properties/${prop.id}`}>
                        <Button
                          size="sm"
                          variant="outline"
                          className="border-[#0E56A4] text-[#0E56A4] hover:bg-blue-50 h-8 text-xs"
                        >
                          View Property
                        </Button>
                      </Link>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="divide-y divide-gray-200">
                ...
                {agent.leads.length === 0 && (
                  <div className="p-8 text-center text-gray-500 italic">No assigned leads.</div>
                )}
              </div>
            </div>
                ...
                <Tabs defaultValue="upcoming">
                  ...
                  <TabsContent value="upcoming" className="space-y-4">
                    {agent.viewings.upcoming.map((viewing: any) => (
                      <div
                        key={viewing.id}
                        className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-lg border border-gray-200 bg-white shadow-sm gap-4"
                      >
                        <div className="flex items-start gap-4">
                          <div className="bg-blue-50 p-3 rounded-lg flex flex-col items-center justify-center min-w-[60px] text-[#0E56A4]">
                            <span className="text-xs font-bold uppercase">
                              {viewing.date.split(' ')[0]}
                            </span>
                            <span className="text-lg font-bold">
                              {viewing.date.split(' ')[1].replace(',', '')}
                            </span>
                          </div>
                          <div>
                    ...
                    {agent.viewings.upcoming.length === 0 && (
                      <p className="text-gray-500 text-center py-4">No upcoming viewings.</p>
                    )}
                  </TabsContent>
                  ...
                  <TabsContent value="completed" className="space-y-4">
                    {agent.viewings.completed.map((viewing: any) => (
                      <div
                        key={viewing.id}
                        className="flex flex-col sm:flex-row items-start justify-between p-4 rounded-lg border border-gray-200 bg-gray-50 gap-4"
                      >
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <h4 className="font-semibold text-gray-900">{viewing.propertyName}</h4>
                    ...
                    {agent.viewings.completed.length === 0 && (
                      <p className="text-gray-500 text-center py-4">No completed viewings.</p>
                    )}
                  </TabsContent>
                </Tabs>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-6 grid grid-cols-2 sm:grid-cols-4 gap-6">
                <div className="text-center p-4 bg-blue-50 rounded-lg border border-blue-100">
                  <p className="text-3xl font-bold text-[#0E56A4] mb-1">
                    {agent.performance.totalProperties}
                  </p>
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg border border-green-100">
                  <p className="text-3xl font-bold text-green-700 mb-1">
                    {agent.performance.viewingsCompleted}
                  </p>
