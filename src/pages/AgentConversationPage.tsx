    ...
    const messageData: Record<number, any[]> = {
      1: [
        {
          id: 1,
          from: 'tenant',
          text: 'Hi! Is the apartment still available for rent?',
          time: '10:30 AM',
        },
        {
          id: 2,
        ...
        },
        {
          id: 3,
          from: 'tenant',
          text: "Yes please! I'm available on Friday afternoon.",
          time: '10:33 AM',
        },
        {
          id: 4,
          from: 'agent',
          text: 'Perfect! How about Friday at 3 PM? I can meet you at the property.',
          time: '10:35 AM',
        },
        {
          id: 5,
          from: 'tenant',
          text: "Yes, I can visit on Friday at 3 PM. What's the exact address?",
          time: '10:40 AM',
        },
      ],
      2: [
        {
          id: 1,
          from: 'tenant',
          text: 'Hello, I saw your listing for the villa. Can you send me more photos?',
          time: 'Yesterday',
        },
        {
          id: 2,
          from: 'agent',
          text: "Of course! I'll send you additional photos of the pool area and garden.",
          time: 'Yesterday',
        },
        {
          id: 3,
          from: 'tenant',
          text: 'Thank you! The property looks amazing.',
          time: 'Yesterday',
        },
        {
          id: 4,
          from: 'agent',
          text: 'Would you like to schedule a viewing? I can show you around this week.',
          time: 'Yesterday',
        },
      ...
      3: [
        {
          id: 1,
          from: 'tenant',
          text: 'I want to apply for this property immediately.',
          time: '3 days ago',
        },
        {
          id: 2,
          from: 'agent',
          text: "Great! I'll send you the application form. Can you provide references?",
          time: '3 days ago',
        },
        {
          id: 3,
          from: 'tenant',
          text: 'Yes, I have references from my previous landlord.',
          time: '3 days ago',
        },
        {
          id: 4,
          from: 'agent',
          text: "Perfect! Let's schedule a viewing first. Tomorrow at 2 PM?",
          time: '3 days ago',
        },
      ...
      4: [
        {
          id: 1,
          from: 'tenant',
          text: 'I confirmed the viewing for tomorrow at 3 PM.',
          time: '4 hours ago',
        },
        {
          id: 2,
          from: 'agent',
          text: "Excellent! I'll prepare all the property details for you.",
          time: '4 hours ago',
        },
        { id: 3, from: 'tenant', text: 'Should I bring any documents?', time: '4 hours ago' },
        {
          id: 4,
          from: 'agent',
          text: 'Just bring your ID. We can discuss the application process during the viewing.',
          time: '3 hours ago',
        },
      ...
      5: [
        {
          id: 1,
          from: 'tenant',
          text: 'What are the nearby amenities? Schools, hospitals, etc.?',
          time: '5 hours ago',
        },
        {
          id: 2,
          from: 'agent',
          text: "Great question! There's a school 5 minutes away and a hospital within 10 minutes.",
          time: '5 hours ago',
        },
        {
          id: 3,
          from: 'tenant',
          text: "That's perfect. What about parking space?",
          time: '5 hours ago',
        },
      ],
      6: [
        {
          id: 1,
          from: 'tenant',
          text: "I've decided to go with another property.",
          time: '2 weeks ago',
        },
        {
          id: 2,
          from: 'agent',
          text: 'Thank you for letting me know. If you need anything in the future, feel free to reach out!',
          time: '2 weeks ago',
        },
      ...
      7: [
        ...
        },
        {
          id: 2,
          from: 'agent',
          text: 'Let me check with the owner. What breed is your dog?',
          time: '6 hours ago',
        },
        {
          id: 3,
          from: 'tenant',
          text: "It's a small Shih Tzu, very quiet and well-trained.",
          time: '6 hours ago',
        },
        {
          id: 4,
          from: 'agent',
          text: 'Good news! The owner is okay with small pets. Would you like to schedule a viewing?',
          time: '5 hours ago',
        },
        {
          id: 5,
          from: 'tenant',
          text: "Great, I'll bring my dog to the viewing.",
          time: '5 hours ago',
        },
      ],
      8: [
        {
          id: 1,
          from: 'tenant',
          text: "I'm very interested in this villa. When can I view it?",
          time: '1 day ago',
        },
        ...
        { id: 3, from: 'tenant', text: 'Perfect! Should I bring documents?', time: '1 day ago' },
        {
          id: 4,
          from: 'agent',
          text: 'Yes, please bring ID and proof of income if possible.',
          time: '1 day ago',
        },
              ...
              <div className="flex items-center justify-between p-4 border-b bg-white">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Ref: {activeConv.referenceCode}</p>
                  </div>
                </div>
                <button
                  onClick={() =>
                    navigate(`/tenant/property-details/${activeConv.propertyId}`, {
                      state: {
                        fromDashboard: true,
                        dashboardType: 'agent-conversation',
