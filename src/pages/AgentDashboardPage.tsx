  ...
  const upcomingViewings = [
    {
      ...
      tenantAvatar: 'https://i.pravatar.cc/150?img=20',
      property: 'Modern 2BR Apartment in New Cairo',
      propertyImage: 'https://images.unsplash.com/photo-1630699375019-c334927264df?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcGFydG1lbnQlMjBiZWRyb29tfGVufDF8fHx8MTc2MzQ2ODc5OXww&ixlib=rb-4.1.0&q=80&w=400',
      status: 'Confirmed'
    },
    {
      id: 2,
      ...
      tenantAvatar: 'https://i.pravatar.cc/150?img=33',
      property: 'Luxury Villa in Madinaty',
      propertyImage: 'https://images.unsplash.com/photo-1728048756954-be23bd048b56?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2aWxsYSUyMHN3aW1taW5nJTIwcG9vbHxlbnwxfHx8fDE3NjMzNzQ5NzJ8MA&ixlib=rb-4.1.0&q=80&w=400',
      status: 'Scheduled'
    },
    {
      id: 3,
      ...
      tenantAvatar: 'https://i.pravatar.cc/150?img=15',
      property: 'Loft in Zamalek',
      propertyImage: 'https://images.unsplash.com/photo-1616045152590-ebda3a20804c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsb2Z0JTIwZGluaW5nJTIwcm9vbXxlbnwxfHx8fDE3NjM0ODAyMjZ8MA&ixlib=rb-4.1.0&q=80&w=400',
      status: 'Pending'
    }
  ];
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
          {assignedProperties.map((property) => (
            <div 
              key={property.id}
              onClick={() => navigate(`/property/${property.id}`, { state: { from: 'agent-dashboard' } })}
            ...
            >
              ...
              <div className="relative">
                ...
                />
                <div className={`absolute top-3 right-3 px-3 py-1 text-xs rounded-full font-medium ${getStatusColor(property.status)}`}>
                  {property.status}
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                ...
                <div className="flex items-center gap-3 sm:contents">
                  ...
                  <div className="flex-1 flex items-center justify-between gap-2 sm:hidden">
                    ...
                    {/* Status Badge */}
                    <span className={`px-2.5 py-1 rounded-full text-xs font-medium flex-shrink-0 ${getLeadStatusColor(lead.status)}`}>
                      {lead.status}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex-1 min-w-0 space-y-1.5 sm:space-y-2">
                  ...
                  <div className="hidden sm:flex items-start justify-between gap-2">
                    ...
                    {/* Status Badge */}
                    <span className={`px-3 py-1 rounded-full text-xs font-medium flex-shrink-0 ${getLeadStatusColor(lead.status)}`}>
                      {lead.status}
                    </span>
                  </div>
          ...
          {upcomingViewings.map((viewing) => (
            ...
            >
              ...
              <div className="relative h-32">
                ...
                />
                <div className={`absolute top-2 right-2 px-3 py-1 text-xs rounded-full font-medium ${getViewingStatusColor(viewing.status)}`}>
                  {viewing.status}
                </div>
              </div>
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-center gap-2 text-[#0E56A4]">
                  ...
                  <span className="font-semibold text-sm">{viewing.date} at {viewing.time}</span>
                </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                ...
                <div className="flex items-center gap-3 sm:contents">
                  ...
                  <div className="flex-1 flex items-center justify-between gap-2 sm:hidden">
                    ...
                    {/* Status Badge */}
                    <span className={`px-2.5 py-1 rounded-full text-xs font-medium flex-shrink-0 ${getMessageStatusColor(message.status)}`}>
                      {message.status}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex-1 min-w-0 space-y-1.5 sm:space-y-2">
                  ...
                  <div className="hidden sm:flex items-start justify-between gap-2">
                    ...
                    {/* Status Badge */}
                    <span className={`px-3 py-1 rounded-full text-xs font-medium flex-shrink-0 ${getMessageStatusColor(message.status)}`}>
                      {message.status}
                    </span>
                  </div>
