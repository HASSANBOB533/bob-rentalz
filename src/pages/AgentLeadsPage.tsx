  ...
  return (
    <div className="space-y-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-1 mb-8">
        ...
        {propertyId && (
          <p className="text-sm text-[#E9C500] mt-2">
            Showing leads for Property ID: {propertyId}
          </p>
        )}
      </div>
      ...
      <div className="flex items-center justify-between">
        <p className="text-gray-600">
          Showing <span className="font-semibold text-[#0E56A4]">{filteredLeads.length}</span> lead{filteredLeads.length !== 1 ? 's' : ''}
        </p>
      </div>
