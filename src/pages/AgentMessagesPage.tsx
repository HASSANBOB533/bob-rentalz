  ...
  const conversations = [
    {
      ...
      lastMessage: "Is this property available for next month? I'm looking for a long-term rental starting from January.",
    ...
    },
    {
      ...
      lastMessage: "I want to apply immediately. The property looks perfect for my family. Can we discuss the terms?",
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className={`text-sm truncate ${
                    conversation.status === "Unread" ? 'font-medium text-gray-800' : 'text-gray-600'
                  }`}>
