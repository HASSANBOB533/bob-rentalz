...
import { Lock, Bell, Mail, MessageSquare, Calendar, Eye, EyeOff, ArrowLeft } from 'lucide-react';
          ...
          <div className="space-y-5">
            ...
            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Instant alerts for new leads</p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    setSettings({ ...settings, leadAlerts: e.target.checked })
                  }
                  className="sr-only peer"
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#0E56A4]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#0E56A4]"></div>
            ...
            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-800">Viewing Reminders</p>
                  <p className="text-sm text-gray-500">Reminders for scheduled viewings</p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={settings.viewingReminders}
                  onChange={(e) =>
                    setSettings({ ...settings, viewingReminders: e.target.checked })
                  }
                  className="sr-only peer"
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#0E56A4]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#0E56A4]"></div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                We recommend using a unique password and enabling all notification options to stay updated on your leads and viewings. Never share your password with anyone.
              </p>
            </div>
          </div>
        </div>
