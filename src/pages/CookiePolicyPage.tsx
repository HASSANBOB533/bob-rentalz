          ...
          <motion.div {...fadeInUp} className="max-w-4xl mx-auto bg-white rounded-2xl p-8 md:p-12 shadow-sm">
            <div className="prose prose-gray max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Cookies are small text files that are stored on your device when you visit a website. They help websites remember your preferences, improve functionality, and provide a better user experience.
              </p>

              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">2. How We Use Cookies</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                BOB Rentalz uses cookies to:
              </p>
              ...
              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">3. Types of Cookies We Use</h2>
              
              <h3 className="text-xl font-semibold text-[#2B2B2B] mb-3 mt-6">Strictly Necessary Cookies</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <ul className="list-disc pl-6 text-gray-700 leading-relaxed mb-6 space-y-2">
                ...
                <li><strong>Social Media Platforms:</strong> To enable social sharing and embedded content</li>
                <li><strong>Payment Processors:</strong> To facilitate secure transactions (if applicable)</li>
              </ul>
              ...
              <ul className="list-disc pl-6 text-gray-700 leading-relaxed mb-6 space-y-2">
                ...
                <li><strong>Cookie Consent Banner:</strong> Adjust your preferences through our cookie consent banner</li>
              </ul>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">7. Updates to This Policy</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                We may update this Cookie Policy from time to time to reflect changes in technology or legal requirements. Please review this page periodically for the latest information.
              </p>
