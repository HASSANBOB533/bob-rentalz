...
export function FAQPage() {
  ...
  const tenantFAQs = [
    ...
    },
    {
      ...
      answer: "Yes! All properties on BOB Rentalz undergo strict verification. We physically inspect each property, verify ownership documents, check safety standards, and ensure all photos and descriptions are accurate. Properties with the 'Verified by BOB' badge have passed our comprehensive quality and safety checks."
    },
    {
      question: "How do I schedule a viewing?",
      answer: "Simply click 'Schedule Viewing' on any property listing, select your preferred date and time, and submit your request. Our agents will confirm within 24 hours. You can also call or WhatsApp the property agent directly using the contact information on the listing page."
    },
    {
      question: "Do I pay any fees to BOB Rentalz as a tenant?",
      answer: "In most cases, tenants pay a one-time placement fee equal to one month's rent when signing the lease. This fee covers tenant screening, contract preparation, and administrative services. There are no monthly fees for tenants. All costs are transparent and communicated upfront."
    },
    {
      question: "Who handles maintenance requests?",
      answer: "BOB Rentalz coordinates all maintenance requests. Simply report any issues through your tenant portal, via WhatsApp, or by calling your property manager. We'll dispatch qualified professionals to handle repairs quickly. Minor maintenance (like changing light bulbs) is typically the tenant's responsibility, while major repairs are covered by the owner."
    },
    {
      question: "Can I negotiate the rental price?",
      answer: "While rental prices are set by property owners, there may be some flexibility depending on the property, lease duration, and market conditions. We recommend discussing your budget with the assigned agent, who can present your offer to the owner. Long-term leases (12+ months) may have more negotiation room."
    },
    {
      question: "What payment methods are accepted for rent?",
      answer: "We accept bank transfers, cash payments at our office, and post-dated checks. For your convenience, we're also implementing online payment options through our tenant portal. Rent is typically paid monthly in advance, with the first and last month's rent plus security deposit due at lease signing."
    },
    {
      question: "Are utilities included?",
      answer: "No, utilities (electricity, water, gas, internet) are typically not included in the rent and are paid directly by the tenant. You'll need to transfer utility accounts to your name or arrange payments according to your lease agreement. Some furnished properties may include internet, but this varies by listing."
    },
    {
      question: "What is the minimum lease duration?",
      answer: "The minimum lease duration for long-term rentals is typically 12 months. However, some properties may offer shorter terms (6-9 months) at a slightly higher monthly rate. All lease terms are clearly stated in the property listing and can be discussed with the property agent."
    },
    {
      question: "What should I do before moving in?",
      answer: "Before moving in, conduct a thorough inspection with your agent and document the property's condition with photos and a written report. Check all appliances, faucets, electrical outlets, and furniture. Report any pre-existing damage to avoid being held responsible later. Keep a copy of your signed lease, inventory list, and all payment receipts."
    }
  ];
  ...
  const agentFAQs = [
    {
      ...
      answer: "Visit our 'Become an Agent' page and submit your application with your real estate license, ID, resume, and references. We'll schedule an interview to discuss your experience, goals, and fit with our platform. Once approved, you'll complete our onboarding training (2-3 days) covering our systems, standards, and best practices before you can start listing properties."
    },
    {
      question: "Do I need previous experience?",
      answer: "While previous real estate experience is preferred, it's not mandatory. We value strong communication skills, customer service orientation, and local market knowledge. Our comprehensive training program will equip you with the tools and knowledge needed to succeed. New agents are paired with experienced mentors for the first 3 months."
    },
    {
      question: "What tools do agents receive?",
      answer: "All BOB Rentalz agents receive access to our proprietary CRM system, mobile app with lead notifications, digital contract templates, marketing materials (business cards, brochures), professional photography services, listing management dashboard, training resources, and dedicated agent support team. We provide everything you need to manage clients professionally."
    },
    {
      question: "How are commissions handled?",
      answer: "Agents earn competitive commissions on successful placements. For long-term rentals, the standard commission is one month's rent (split between listing and tenant agents if applicable). Commissions are paid within 7 business days of lease signing and first rent payment. We also offer performance bonuses for top performers and referral incentives."
    },
    {
      question: "Can I manage my own listings?",
      answer: "Yes! Agents can list properties directly through our platform. You'll have full control over your listings, including pricing, descriptions, photos, and availability. All listings must meet our quality standards and pass verification. You can also work with properties listed by other agents in our network."
    },
    {
      question: "Does BOB Rentalz provide leads?",
      answer: "Yes, we distribute qualified leads to our agent network based on specialization, location, and performance. Leads come from our website, social media, referrals, and marketing campaigns. Agents with strong track records and positive reviews receive priority lead assignment. You can also generate your own leads and bring them to the platform."
    },
    {
      question: "What is the verification process?",
      answer: "All agents undergo identity verification (national ID check), background screening, license validation (if applicable), reference checks from previous employers or clients, and an interview with our recruitment team. We also conduct periodic performance reviews to ensure all agents maintain our high standards of professionalism and service."
    },
    {
      question: "How do I contact agent support?",
      answer: "Agent support is available Monday-Saturday, 9 AM - 6 PM via phone (+20 100 123 4567), WhatsApp, email (agents@bobrentalz.com), or through the agent portal help desk. For urgent issues outside business hours, we have an emergency hotline. We typically respond to inquiries within 2 hours during business hours."
    }
  ];
