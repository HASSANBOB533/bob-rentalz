...
export function HomePage() {
  ...
  const popularLocations = [
    { name: 'New Cairo', slug: 'new-cairo', count: 150, imageUrl: newCairoImage },
    {
      ...
      count: 120,
      imageUrl:
        'https://images.unsplash.com/photo-1720400995876-506098f4c238?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxDYWlybyUyME5pbGUlMjBSaXZlciUyMEVneXB0fGVufDF8fHx8MTc2MzA1ODc4N3ww&ixlib=rb-4.1.0&q=80&w=1080',
    },
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            ...
            >
              ...
              <h1 className="mb-4 leading-[1.1] text-[26px] sm:text-[32px] md:text-[42px] lg:text-[52px] xl:text-[58px] font-[800] text-white drop-shadow-2xl w-full tracking-tight">
                <span className="text-[#E9C500]">Best of Bedz Rentalz</span>
                <br />
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            {popularLocations.map((location, index) => (
              <LocationCard key={location.slug} {...location} delay={index * 0.1} />
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-block px-4 py-2 bg-[#E9C500]/10 rounded-full mb-2">
              <span className="text-[#E9C500] font-[600] text-[12px] md:text-[13px] uppercase tracking-wide">
                Our Promise
              </span>
            </div>
