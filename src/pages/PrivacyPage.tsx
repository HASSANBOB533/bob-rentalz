          ...
          <motion.div {...fadeInUp} className="max-w-4xl mx-auto bg-white rounded-2xl p-8 md:p-12 shadow-sm">
            <div className="prose prose-gray max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                BOB Rentalz ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services. This policy is GDPR-compliant and applies to tenants, property owners, and real estate agents.
              </p>

              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">2. Information We Collect</h2>
              ...
              <ul className="list-disc pl-6 text-gray-700 leading-relaxed mb-6 space-y-2">
                ...
                <li><strong>Property Information:</strong> Property details, location, photos, and rental preferences</li>
              ...
              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">3. How We Use Your Information</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">4. Legal Basis for Processing (GDPR)</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">5. Data Sharing and Disclosure</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                We do not sell your personal information. We may share your information with:
              </p>
              <ul className="list-disc pl-6 text-gray-700 leading-relaxed mb-6 space-y-2">
                <li><strong>Property Owners & Agents:</strong> To facilitate rental inquiries and viewings</li>
                <li><strong>Service Providers:</strong> Third-party vendors who assist with hosting, analytics, and communications</li>
              ...
              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">9. Cookies and Tracking</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                We use cookies and similar tracking technologies to enhance your browsing experience. For more information, please see our Cookie Policy.
              </p>
              ...
              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">11. Changes to This Policy</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
