...
export default function TenantRentedDashboardPage() {
  ...
  return (
    <DashboardLayout userRole="renter" userName={tenantName} onLogout={() => navigate('/login')}>
      <div className="space-y-6 md:space-y-7 lg:space-y-8">
        ...
        <div className="bg-gradient-to-r from-[#0E56A4] to-[#0A3F79] rounded-2xl p-6 md:p-8 text-white">
          ...
          <p className="text-white/90 text-sm md:text-base">
            Manage your rentals and service requests
          </p>
        </div>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
                    ...
                    <div className="relative h-48 md:h-auto">
                      ...
                      />
                      <div
                        className={`absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-medium ${leaseEnded ? 'bg-red-500 text-white' : 'bg-green-500 text-white'}`}
                      >
                    ...
                    <div className="col-span-2 p-5 md:p-6">
                        ...
                        <div className="mb-4 bg-yellow-50 border border-yellow-200 rounded-lg p-3 flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-yellow-700">
                              The lease for this property ended on {rental.leaseEnd}. Please contact
                              the owner or admin for renewal or move-out procedures.
                            </p>
                          </div>
                        </div>
                      )}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className={`font-medium ${leaseEnded ? 'text-red-600' : ''}`}>
                            {rental.leaseEnd}
                          </span>
                        </div>
                      </div>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap ${getStatusColor(request.status)}`}
                    >
                      {request.status}
                    </span>
                    <Button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          >
            ...
            <p className="text-sm text-white/80">
              Access lease agreements, receipts, and important documents
            </p>
          </div>
