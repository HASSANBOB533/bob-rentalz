            ...
            >
              ...
              <div className="relative h-48 bg-gray-50 border-b border-gray-100 flex items-center justify-center group-hover:bg-gray-100 transition-colors">
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
                  <Button
                    variant="secondary"
                    size="sm"
                    className="bg-white/90 hover:bg-white text-[#0E56A4]"
                  >
              ...
              <div className="p-5 flex flex-col flex-1">
                <div className="flex items-start justify-between gap-3 mb-2">
                  <Badge
                    variant="secondary"
                    className={`text-[10px] px-2 py-0.5 border ${getCategoryColor(doc.category)}`}
                  >
                    {doc.category}
                  </Badge>
                ...
                <p className="text-xs text-gray-500 mb-4 line-clamp-1">{doc.property}</p>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                This document archive is managed by your property manager. You can view and download
                files, but cannot modify or delete them. Contact support if you find any
                discrepancies.
              </p>
            </div>
          </div>
              ...
              {selectedDoc ? (
                selectedDoc.format === 'PDF' ? (
                  ...
                  <div className="bg-white shadow-lg rounded-lg w-full max-w-3xl h-full min-h-[400px] flex flex-col items-center justify-center p-8 text-center border border-gray-200">
                    ...
                    <Button
                      variant="outline"
                      className="border-[#0E56A4] text-[#0E56A4] hover:bg-[#0E56A4]/5"
                    >
                      Open in New Tab
                    </Button>
                  </div>
