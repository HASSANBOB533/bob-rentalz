...
export default function TenantSavedPropertiesPage() {
  ...
  const savedProperties = [
    ...
    },
    {
      ...
      bathrooms: 2,
      area: '150 sqm',
      image: 'https://images.unsplash.com/photo-1716713438776-13a7a9dee523?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcGFydG1lbnQlMjBiYWxjb255JTIwZ2FyZGVufGVufDF8fHx8MTc2MzQ4MDIyNXww&ixlib=rb-4.1.0&q=80&w=1080',
      cycle: 1
    },
    {
      id: 6,
      ...
      bathrooms: 2,
      area: '180 sqm',
      image: 'https://images.unsplash.com/photo-1616045152590-ebda3a20804c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsb2Z0JTIwZGluaW5nJTIwcm9vbXxlbnwxfHx8fDE3NjM0ODAyMjZ8MA&ixlib=rb-4.1.0&q=80&w=1080',
      cycle: 1
    }
