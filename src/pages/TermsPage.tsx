          ...
          >
            <div className="prose prose-gray max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                By accessing and using the BOB Rentalz website and services, you accept and agree to
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                BOB Rentalz provides a platform for property listings, browsing, and connecting
                property owners, tenants, and agents. Our services include:
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                All property listings on BOB Rentalz are subject to verification. While we strive to
                ensure accuracy, we do not guarantee the availability or condition of any listed
                property. Users should conduct their own due diligence before entering into any
                rental agreement.
              </p>

              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">5. Rental Agreements</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                BOB Rentalz acts as an intermediary platform. All rental agreements, payments, and
                legal obligations are between the property owner and tenant. BOB Rentalz is not a
                party to these agreements and assumes no liability for disputes arising from rental
                transactions.
              </p>

              <h2 className="text-2xl font-semibold text-[#2B2B2B] mb-4">6. Fees and Payments</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                Property owners and agents may be subject to listing fees or commission structures
                as outlined in separate agreements. All fees are clearly communicated before any
                service commitment.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                BOB Rentalz provides services &quot;as is&quot; without warranties of any kind. We
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                All content, trademarks, logos, and intellectual property on the BOB Rentalz
                platform are owned by Best of Bedz and are protected by applicable copyright and
                trademark laws.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                BOB Rentalz reserves the right to modify these Terms and Conditions at any time.
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                Any disputes shall be resolved in the courts of Cairo, Egypt.
              </p>
